...
const router = createRouter({
  ...
  routes: [
    ...
    {
      path: '/formulario_listar',
      name: 'formulario_listar',
      component: () => import('../views/formulario/formulario_listar.vue')
    },
    {
      path: '/formulario_crear',
      name: 'formulario_crear',
      component: () => import('../views/formulario/formulario_crear.vue')
    },
    {
      path: '/formulario_editar/:id',
      name: 'formulario_editar',
      component: () => import('../views/formulario/formulario_editar.vue')
    }
  ]
})
